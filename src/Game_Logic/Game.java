    ...
    public void gameLoop()
    {
        ...
        while(true)
        {
            ...
            if(!handIsValid(hands[player_turn]))
            {
                ...
                while (deck.peekDeck().color != deck.peekDiscard().color) {
                    hands[player_turn].add(deck.drawCard());
                }
                hands[player_turn].add(deck.drawCard()); // draw a card that is valid (i.e. is the same color)
            }
